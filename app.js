...
const apisOT = require('./Server/apis/apisOT');
const apisRH = require('./Server/apis/apisRH');
const apisFA = require('./Server/apis/apisFA');
...
app.use('/volvo/api/OT',apisOT);
app.use('/volvo/api/RH',apisRH);
app.use('/volvo/api/FA',apisFA);
