var GlobalURL = "https://localhost:3000/volvo/api/OT/OT_J_APROVACION_LISTA";
...
$('#btnAprobar').on('click', function() {
    (async function(){
        var respuesta = await aprobarLista();
        switch (respuesta.output.pcodigoMensaje){
            case 0:{
                alert('Lista Aprobada');
                break;
            }
            case 5:{
                alert('No se puede aprobar la lista actualmente. Consulte el estado de orden de trabajo.');
                break;
            }
            case 4:{
                alert('Orden de trabajo no encontrada');
