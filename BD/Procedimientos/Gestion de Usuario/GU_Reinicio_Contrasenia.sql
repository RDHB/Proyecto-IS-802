...
BEGIN
    ...
    */
    IF @paccion = 'RESET' BEGIN
		 ...
		 * UNION ALL
		 * SELECT dbo.FN_RANDOM_STRING(8,'N'),'Solo N�meros'  --Cadena aleatoria que contiene N�meros.
		 * UNION ALL
		 * SELECT dbo.FN_RANDOM_STRING(8,'CN'), 'Letras y N�meros'--Cadena aleatoria que contiene Letras y N�meros.
		*/
